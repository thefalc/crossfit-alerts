...
class SwiftMailerComponent extends Object {
    ...
    function send($view = 'default', $subject = '', $method = 'smtp') {
        ...
        // header for tracking categories within SendGrid
        $message->getHeaders()->addTextHeader("X-SMTPAPI", "{\"category\": \"".$view."\"}");
        ...
        switch ($method) {
            case 'smtp':
                $transport = Swift_SmtpTransport::newInstance($this->smtpHost, $this->smtpPort, $this->smtpType, $this->tcpOverride);
